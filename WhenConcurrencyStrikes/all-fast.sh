...
./pony-savina/savina-pony/savina-pony --benchmark "Banking 2PC" --reps 5 --ponymaxthreads 1 > outputs/pony-banking-2pc-1.txt
./pony-savina/savina-pony/savina-pony --benchmark "Banking 2PC" --reps 5 --ponymaxthreads 8 > outputs/pony-banking-2pc-8.txt
